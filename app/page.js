    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-t from-orange-50 via-transparent to-transparent pointer pointer-events-none z-10" />
          <div className="bg-white rounded-2xl p-4 max-full mx-auto">
            ...
            <div className="space-y-4 p-4">
              <h3 className="text-xl font-semibold text-orange-900">
                {advice ? advice : "My Thought's Today"}
              </h3>
          ...
          <div className="space-y-16">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                ...
                <span className="">Format with ease</span>
              </li>
              <li className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-orange-400" />
                <span className="">Embed Links</span>
              </li>
            </ul>
          </div>
